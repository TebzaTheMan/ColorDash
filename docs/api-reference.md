...
```json
{
  ...
  "mode": "rgb",
  "colors": ["rgb(12,34,56)", "rgb(78,90,12)", "rgb(34,56,78)", "rgb(90,12,34)", "rgb(56,78,90)", "rgb(12,90,56)"],
...
```json
{
  ...
  "triesLeft": 3,
  "gameOver": false,
  "nextColors": ["rgb(...)", "rgb(...)", "rgb(...)", "rgb(...)", "rgb(...)", "rgb(...)"],
  "nextTargetLabel": "rgb(99,11,44)"
}
```

`result` is one of: `"Correct"` | `"WrongButContinue"` | `"WrongAndExhausted"`
