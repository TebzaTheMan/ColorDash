...
| `web/components/icons/`                                   | Reusable inline SVG icon components (`ArrowRightIcon`, `CheckIcon`, `XIcon`, `ExternalLinkIcon`, `ReplayIcon`) — `stroke="currentColor"`, `size`/`strokeWidth` props |
